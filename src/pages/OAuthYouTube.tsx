    ...
    const handleCallback = async () => {
      ...
      if (error) {
        ...
        toast({
          ...
          description: `YouTube authorization was denied: ${error}`,
          variant: "destructive",
        });
      ...
      try {
        ...
        const { data, error: exchangeError } = await supabase.functions.invoke('youtube-oauth-callback', {
          body: { code }
        });
        ...
        const { error: insertError } = await supabase
          ...
          .upsert({
            user_id: user.id,
            platform: 'youtube',
            platform_user_id: data.channel_id,
            platform_username: data.channel_title,
