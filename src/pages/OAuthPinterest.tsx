    ...
    const handleCallback = async () => {
      ...
      if (error) {
        ...
        toast({
          ...
          description: `Pinterest authorization was denied: ${error}`,
          variant: "destructive",
        });
      ...
      try {
        ...
        const { data, error: exchangeError } = await supabase.functions.invoke('pinterest-oauth-callback', {
          body: { code }
        });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Pinterest OAuth</CardTitle>
          <CardDescription>
            {status === "loading" && "Connecting your Pinterest account..."}
